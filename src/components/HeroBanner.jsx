    ...
    return (
        ...
        >
            ...
            <Wrapper>
                {/* NAVBAR START */}
                <motion.div
                    className="hidden md:flex items-center justify-between mt-[40px] relative"
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Harsh Raj</span>
                    </div>
                    <div className="max-w-[510px]">
                    Experienced web developer skilled in React, tailwind for building dynamic and responsive websites. 
                    Strong problem-solving skills and attention to detail for delivering high-quality, scalable code. 
                    </div>
                </motion.div>
                {/* INTRO END */}
