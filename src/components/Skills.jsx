...
// IMAGES
import sk1 from "../assets/sk-8.png";
import sk2 from "../assets/sk-9.png";
import sk3 from "../assets/sk-10.png";
import sk4 from "../assets/sk-11.png";
                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        ...
                        <Service
                            ...
                            desc="CLASS 12th Science (Non medical)"
                            data={[
                                "2019 - 2021",
                                "82.2%"
                            ]}
